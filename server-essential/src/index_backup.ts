...
server.registerEndpoint(
  {
    path: '/api/test/auth', method: HTTPMethods.GET, guards: [authGuard, roleEndpointGuard], controller: (req: Request, res: Response) => { 
      res.send(`Hello ${req["userId"]}, You are authenticated!`); 
    }
  }
);
